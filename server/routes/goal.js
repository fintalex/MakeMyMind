...
// Http://localhost:5015/api/getGoalsByUserAndStatus/234234/2 (GET)
router.get('/getGoalsByUserAndStatus/:userId/:status', goalService.getGoalsByUserAndStatus);

// Http://localhost:5015/api/getMyGoalsCount/234234/3 (GET)
router.get('/getMyGoalsCount/:userId/:status', goalService.getMyGoalsCount);
